...
collection1.insert_one(data1)
 # we can store different type of data inside databases we are not defining the scheema of it. in case of nosql we need not to worry about the structure of data
